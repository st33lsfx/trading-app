...
<style>
    ...
    .metric-card .value.positive { color: #00d26a; }
...
<div style="text-align: center; padding: 20px 0 24px 0; border-bottom: 1px solid #2d3748; margin-bottom: 20px;">
    ...
    ">📈</div>
    <h2 style="margin: 0; font-size: 1.3rem; font-weight: 700; color: #f8fafc;">TradingBot</h2>
    <p style="margin: 4px 0 0 0; font-size: 0.75rem; color: #64748b;">Automated Trading System</p>
</div>
""", unsafe_allow_html=True)
...
">
    <p style="color: #64748b; font-size: 0.75rem; margin: 0; text-align: center;">
        💡 Tip: Priority trhy jsou označeny ⭐<br>
        Blacklistované trhy jsou automaticky vynechány.
    </p>
</div>
""", unsafe_allow_html=True)
...
with tabs[3]:
    ...
    def show_performance():
        ...
        st.caption("Last 24 hours trading activity from Capital.com")
